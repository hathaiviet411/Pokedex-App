...
export default function SuccessResetPassword(props) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ flex: 9, width: '100%' }}>
        ...
        <Text style={styles.title}>Your password was successfully reseted!</Text>

        <Text style={styles.content}>Welcome, coach! We are excited to follow your journey.</Text>

        <TouchableOpacity style={[styles.buttonEmail, { marginTop: 50 }]} onPress={() => { navigateToAlphaLogin() }}>
